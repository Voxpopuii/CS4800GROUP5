...
from create_user_class import CreateUserManager
...
-You need the to import the following libraries: login_class.py, create_user_class.py
login_class.py
create_user_class.py
...
16-19, 70, 73, 151, 159, 167, 179, 192, 200, 208, 220, 281, 289, 300, 471, 474, 
...
the correct python files, you need to run all the 2 python files in line 28. 
